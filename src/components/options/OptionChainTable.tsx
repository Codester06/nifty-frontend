...
import MobileOptionChain from './MobileOptionChain';
import type { OptionChainData, OptionContract, OptionChainTableProps, SortConfig } from '@/shared/types';
...
const OptionChainTable: React.FC<OptionChainTableProps> = ({
  ...
  // Use mobile component on mobile devices (after all hooks)
  if (isMobile) {
    return (
      <MobileOptionChain
        options={options}
        ...
        <thead className="bg-gray-50/80 dark:bg-slate-800/80 backdrop-blur-sm">
          <tr>
            ...
            <th
              ...
              tabIndex={0}
              className="px-3 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-inset"
            ...
            <th
              ...
              tabIndex={0}
              className="px-4 py-3 text-center text-xs font-medium text-gray-900 dark:text-white uppercase tracking-wider cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-600 bg-gray-100 dark:bg-gray-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-inset"
