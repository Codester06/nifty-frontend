...
import { Wallet, TrendingUp, TrendingDown, Clock, BarChart3, Eye, Star, Heart, Trash2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-gray-200/50 dark:border-slate-700/50">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 rounded-xl border border-green-200 dark:border-green-700">
                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-green-700 dark:text-green-300 font-medium">Live Market</span>
              </div>
        ...
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-3xl shadow-xl border border-gray-200/50 dark:border-slate-700/50 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-blue-200 text-xs mt-1">Available funds</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-emerald-100 text-sm font-medium">Total Investment</p>
                  <p className="text-3xl font-bold mt-2">
                    ₹{totalInvestment.toLocaleString()}
                  </p>
                  <p className="text-emerald-200 text-xs mt-1">Capital deployed</p>
                </div>
                <div className="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
        ...
        {/* Market Overview with Stock Charts */}
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-3xl shadow-xl border border-gray-200/50 dark:border-slate-700/50 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {liveStocks.slice(0, 6).map((stock) => (
              <StockChart
                key={stock.symbol}
                symbol={stock.symbol}
                name={stock.name}
          ...
          {liveStocks.length > 0 && (
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Featured Stock</h3>
              <StockChart
                symbol={liveStocks[0].symbol}
                name={liveStocks[0].name}
                currentPrice={liveStocks[0].price}
                change={liveStocks[0].change}
                changePercent={liveStocks[0].changePercent}
                variant="detailed"
              />
            </div>
          )}
