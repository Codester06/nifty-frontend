...
import { TrendingUp, TrendingDown, BarChart3, Shield, Zap, Newspaper, Heart, Lock, CheckCircle, Star, Users, Award, Globe, MessageCircle, Phone, Mail, HelpCircle, Clock, Verified } from 'lucide-react';
import { mockStocks, startLivePriceUpdates } from '../data/mockStocks';
import { Stock } from '../types/types';
import TradingViewWidget from '../components/TradingViewWidget';
import TechnicalAnalysisWidget from '../components/TechnicalAnalysisWidget';
import { useAuth } from '../hooks/useAuth';
import { mockSocialProofData, mockTrustMetrics, mockSecurityBadges, mockSupportOptions, getLiveSocialProofData } from '../data/trustData';
          ...
          <div className="text-center">
            ...
            <div className="max-w-5xl mx-auto mb-12">
              <p className="text-xl sm:text-2xl md:text-3xl text-gray-200 mb-6 leading-relaxed font-light">
                Transform your financial future with comprehensive stock market education
              </p>
              <p className="text-lg sm:text-xl text-gray-300 leading-relaxed mb-6">
                Learn from experts • Practice with real data • Build lasting wealth
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Master stock analysis using live data from NSE's top companies. Learn technical analysis, 
              fundamental research, and portfolio management with real market movements.
            </p>
          </div>
            ...
            <div className="px-8 py-6 border-b border-gray-200/50 dark:border-slate-700/50 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-700/50 dark:to-slate-600/50">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Live Market Dashboard</h3>
                    <p className="text-gray-600 dark:text-gray-300">Real-time NSE data for learning</p>
                  </div>
                </div>
                  ...
                  >
                    ...
                    <div className="space-y-5">
                      ...
                      <div className={`p-4 rounded-2xl border-2 ${
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Change Today</span>
                      ...
                      <div className="h-12 bg-gray-50 dark:bg-slate-600/50 rounded-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="flex items-center space-x-1">
                          <div className={`w-1 h-6 rounded-full ${isPositive ? 'bg-green-400' : 'bg-red-400'}`}></div>
                          <div className={`w-1 h-4 rounded-full ${isPositive ? 'bg-green-300' : 'bg-red-300'}`}></div>
                          <div className={`w-1 h-8 rounded-full ${isPositive ? 'bg-green-500' : 'bg-red-500'}`}></div>
                          <div className={`w-1 h-3 rounded-full ${isPositive ? 'bg-green-300' : 'bg-red-300'}`}></div>
                          <div className={`w-1 h-7 rounded-full ${isPositive ? 'bg-green-400' : 'bg-red-400'}`}></div>
                          <div className={`w-1 h-5 rounded-full ${isPositive ? 'bg-green-300' : 'bg-red-300'}`}></div>
                          <div className={`w-1 h-9 rounded-full ${isPositive ? 'bg-green-500' : 'bg-red-500'}`}></div>
                        </div>
                      </div>
                ...
                >
                  {showAllStocks ? (
                    <>
                      ...
                      Show Less Stocks
                      <svg className="ml-3 h-5 w-5 rotate-180 group-hover:translate-y-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <>
                      ...
                      <svg className="ml-3 h-5 w-5 group-hover:translate-y-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
                    </>
                  )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Comprehensive courses designed by experts to help you understand markets, analyze stocks, and make informed decisions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="group bg-white dark:bg-slate-800/80 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 text-center">Stock Market Fundamentals</h3>
              <p className="text-gray-600 dark:text-gray-300 text-center mb-6 leading-relaxed">
                Master the basics: market mechanics, stock valuation, financial statements, and investment psychology
              </p>
            ...
            <div className="group bg-white dark:bg-slate-800/80 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 text-center">Technical Analysis Mastery</h3>
              <p className="text-gray-600 dark:text-gray-300 text-center mb-6 leading-relaxed">
                Advanced charting techniques, pattern recognition, momentum indicators, and timing strategies
              </p>
              <div className="space-y-3 mb-6">
                <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="group bg-white dark:bg-slate-800/80 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 text-center">Wealth Building Strategies</h3>
              <p className="text-gray-600 dark:text-gray-300 text-center mb-6 leading-relaxed">
                Portfolio optimization, asset allocation, risk management, and long-term wealth creation strategies
              </p>
              <div className="space-y-3 mb-6">
                <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
      ...
      <section className="py-16 bg-white dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Tailored learning paths based on your experience level and investment goals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-3xl p-8 border border-green-200 dark:border-green-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="absolute top-4 right-4">
                <span className="px-3 py-1 bg-green-500 text-white text-xs font-bold rounded-full">BEGINNER</span>
              </div>
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Foundation Builder</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Perfect for complete beginners. Start with market basics and build a solid foundation.
              </p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Market Fundamentals</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Investment Basics</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-500" />
                ...
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-green-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Virtual Trading</span>
                </div>
              </div>
            ...
            <div className="group relative bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-3xl p-8 border border-blue-200 dark:border-blue-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="absolute top-4 right-4">
                <span className="px-3 py-1 bg-blue-500 text-white text-xs font-bold rounded-full">INTERMEDIATE</span>
              </div>
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Strategy Developer</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                For those with basic knowledge. Develop advanced analysis skills and trading strategies.
              </p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-blue-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Technical Analysis</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-blue-500" />
                ...
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-blue-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Trading Psychology</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-blue-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Strategy Backtesting</span>
                </div>
              </div>
            ...
            <div className="group relative bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-3xl p-8 border border-purple-200 dark:border-purple-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="absolute top-4 right-4">
                <span className="px-3 py-1 bg-purple-500 text-white text-xs font-bold rounded-full">ADVANCED</span>
              </div>
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Wealth Master</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                For experienced investors. Master advanced strategies and portfolio management.
              </p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-purple-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Portfolio Optimization</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-purple-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Options & Derivatives</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-purple-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">Algorithmic Trading</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-purple-500" />
                  <span className="text-sm text-gray-600 dark:text-gray-400">1-on-1 Mentoring</span>
                </div>
              </div>
          ...
          <div className="mt-16 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-3xl p-8 border border-indigo-200 dark:border-indigo-700">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Success Stories</h3>
              <p className="text-gray-600 dark:text-gray-400">Real results from our learning community</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-indigo-600 dark:text-indigo-400">₹2.5L+</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Average portfolio growth</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600 dark:text-purple-400">85%</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Students see positive returns</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-pink-600 dark:text-pink-400">6 months</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Average time to profitability</div>
              </div>
            </div>
          </div>
        </div>
